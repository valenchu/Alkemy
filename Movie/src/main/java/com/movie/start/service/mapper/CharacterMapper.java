...
public class CharacterMapper {
    ...
    public void editCharacter(CharacterEntity character, CharacterWithOutMovieDto characterCompress)
	    throws MesaggeError {
	if (character != null && characterCompress != null) {
	    ...
	    throw new MesaggeError(
		    "entity null in mapper character" + characterCompress.toString() + " " + character.toString());
	}

    }

    public CharacterWithOutMovieDto characterEntity2characterWitoutDto(Object characterEntity) {
